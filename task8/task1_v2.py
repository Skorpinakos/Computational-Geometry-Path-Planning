...
generate_point_cloud_from_mesh(filename,pcd_filename,25)
pcd = o3d.io.read_point_cloud(pcd_filename)


# Rotate point cloud and mesh initially by (x, y, z) degrees
rotation_degrees = (8, 10, 28)  # Example degrees of rotation
...
cylinder_aligned = create_axis_cylinders(origin=np.array([0, 0, 0]), length=50.0, radius=0.2)
...
if os.path.exists("results/pcd_from_task1.ply"):
    os.remove("results/pcd_from_task1.ply")
